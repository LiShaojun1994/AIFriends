    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(upload_to=web.models.character.upload_photo)),
                ('profile', models.TextField(max_length=100000)),
                ('background_image', models.ImageField(upload_to=web.models.character.background_image_upload_photo)),
